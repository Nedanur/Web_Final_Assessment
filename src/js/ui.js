...
function toggleLoading(isLoading) {
  ...
  if (isLoading) {
    document.getElementsByClassName("sButton").innerHTML =
      '<i class="fa fa-hourglass"></i> Loading';
    document.getElementsByClassName("sButton").disabled = true;
  } else if (!isLoading) {
    document.getElementsByClassName("sButton").innerHTML = "&#x1F50D; Search";
    document.getElementsByClassName("sButton").disabled = false;
  }
